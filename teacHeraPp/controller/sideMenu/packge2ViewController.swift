...
class packge2ViewController: UIViewController {

    var tonextAlert:popup!
    var currencyTXT = UITextField()
    var iconClick = true
    var imgClick = UIImageView()
    ...
    override func viewDidLoad() {
        ...
        let conntentView = UIView()
        conntentView.addSubview(imgClick)
        conntentView.frame = CGRect(x: 0, y: 0, width: CGFloat(Int(UIImage(named: "Icon ionic-ios-arrow-back")!.size.width)), height: (UIImage(named: "Icon ionic-ios-arrow-back")?.size.height)!)
        ...
        BankName.leftView = conntentView
...
extension packge2ViewController:UITextFieldDelegate,UIPickerViewDelegate,UIPickerViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        case 3:
            ...
            conntentView3.frame = CGRect(x: 0, y: 0, width: CGFloat(Int(UIImage(named: "Icon ionic-ios-arrow-back")!.size.width)), height: (UIImage(named: "Icon ionic-ios-arrow-back")?.size.height)!)
            imgClick.frame = CGRect(x: 10, y: 0, width: CGFloat(Int(UIImage(named: "Icon ionic-ios-arrow-back")!.size.width)), height: (UIImage(named: "Icon ionic-ios-arrow-back")?.size.height)!)
            moneyTrans.leftView = conntentView3
            moneyTrans.leftViewMode = .always
            iconClick = true
        case 2:
