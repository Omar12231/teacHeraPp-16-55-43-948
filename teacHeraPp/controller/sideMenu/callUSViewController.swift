...
class callUSViewController: UIViewController {
    ...
    @IBOutlet weak var mesg: UITextField!
    ...
    override func viewDidLoad() {
        ...
        editepicker()
        spaceText(textfield: nameTxt)
        spaceText(textfield: PhoneNum)
        countrytxt.frame = CGRect(x: 0, y: 7, width: 50, height: 50)
        countrytxt.placeholder = " +966 "
...
extension callUSViewController:UITextFieldDelegate,UIPickerViewDelegate, UIPickerViewDataSource{
